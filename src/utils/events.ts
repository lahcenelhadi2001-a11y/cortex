...
export interface EventPayloads {
  ...
  [EVENTS.TERMINAL.SPLIT_VERTICAL]: void;
  [EVENTS.TERMINAL.SPLIT_HORIZONTAL]: void;
  [EVENTS.TERMINAL.CLOSE_SPLIT_PANE]: void;
  [EVENTS.TERMINAL.NAVIGATE_SPLIT]: { direction: string };
  [EVENTS.TERMINAL.CLOSE_TAB]: { tabId: string };
